...
bool CAddonMgr::AddRuleToList(const std::string& id, AddonUpdateRule updateRule)
{
  return m_updateRules.AddRuleToList(m_database, id, updateRule);
}

bool CAddonMgr::RemoveAllRulesFromList(const std::string& id)
{
  return m_updateRules.RemoveAllRulesFromList(m_database, id);
}

bool CAddonMgr::RemoveRuleFromList(const std::string& id, AddonUpdateRule updateRule)
{
  return m_updateRules.RemoveRuleFromList(m_database, id, updateRule);
}
