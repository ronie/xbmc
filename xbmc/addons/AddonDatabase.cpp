...
bool CAddonDatabase::SetUpdateRuleForAddon(const std::string& addonID, AddonUpdateRule updateRule)
{
  try
  {
    if (!m_pDB)
...
{
  return RemoveUpdateRuleForAddon(addonID, AddonUpdateRule::NONE);
}
