  ...
  */
  ...
  public:
    ...
    */
     ...
     * \sa CAddonUpdateRules::AddRuleToList()
     */
    bool AddRuleToList(const std::string& id, AddonUpdateRule updateRule);

    /* \brief Remove all rules from update rules list for an addon
     * \sa CAddonUpdateRules::RemoveAllRulesFromList()
     */
    bool RemoveAllRulesFromList(const std::string& id);

    /* \brief Remove a specific rule from update rules list for an addon
     * \sa CAddonUpdateRules::RemoveRuleFromList()
     */
    bool RemoveRuleFromList(const std::string& id, AddonUpdateRule updateRule);
