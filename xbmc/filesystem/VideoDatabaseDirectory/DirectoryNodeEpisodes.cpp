...
bool CDirectoryNodeEpisodes::GetContent(CFileItemList& items) const
{
  ...
  bool bSuccess=videodatabase.GetEpisodesNav(BuildPath(), items, params.GetGenreId(), params.GetYear(), params.GetActorId(), params.GetDirectorId(), params.GetTvShowId(), season, SortDescription(), VideoDbDetailsRating | VideoDbDetailsUniqueID);
